	...
	function updateLibrayImage(img_list){
		...
		if(is_update){
			...
			$.each(img_list,function(index,_img_src){
				...
				var encoded_img_src = img_src.replace(/ /g, '%20');
				html += "<div class='123123 float_l img_tools _library_img "+add_class+"' style='background-image: url("+encoded_img_src+")' data-id='"+_img_src+"'>";
